...
export function CallToAction () {
  return (
  <div className="relative isolate overflow-hidden w-full max-w-7xl flex flex-col items-center justify-center px-6 py-24 sm:px-24 xl:py-32 rounded-3xl bg-blue-700 shadow-2xl">
    <motion.h2
    ...
    <motion.p
      ...
      className="mx-auto mt-2 max-w-xl text-center text-2xl leading-9 text-blue-100 mb-12"
    >

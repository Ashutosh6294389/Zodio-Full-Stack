                            ...
                            <div className="sm:mx-auto lg:mr-auto flex flex-col items-center text-center">
                                ...
                                >
                                    <span className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-black border border-border backdrop-blur-sm mb-6">
                                        <span className="text-lg font-medium text-muted-foreground text-white"> Solutions You'll Need</span>
                                    </span>
                                    <h1
                                        className="max-w-4xl text-balance text-5xl font-medium md:text-6xl ">
                                        Achieve More With Our — <span className='text-primary'>Seamless Solutions</span>
                                    </h1>
                                    <p
                                        className="mt-4 max-w-4xl text-pretty text-lg md:text-xl">
                                        From smarter hiring for companies to career-boosting tools for
                                    </p>
                                    <p
                                        className="mt-4 max-w-4xl text-pretty text-lg md:text-xl">
                                        job seekers — explore solutions built to empower both sides.
                                    </p>
                                </AnimatedGroup>
                            </div>
                        </div>

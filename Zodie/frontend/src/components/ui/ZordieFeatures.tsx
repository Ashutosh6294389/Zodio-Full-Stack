...
export default function ZordieFeatures() {
  const appsRow1 = [
    <img src={slack} alt="Slack" className="h-10 w-10" />,
    <img src={zoom} alt="Zoom" className="h-10 w-10" />,
    <img src={teams} alt="Teams" className="h-10 w-10" />,
    <img src={jira} alt="Jira" className="h-10 w-10" />,
    <img src={github} alt="GitHub" className="h-10 w-10" />,
  ];
  const appsRow2 = [
    <img src={notion} alt="Notion" className="h-10 w-10" />,
    <img src={figma} alt="Figma" className="h-10 w-10" />,
    <img src={drive} alt="Drive" className="h-10 w-10" />,
    <img src={asana} alt="Asana" className="h-10 w-10" />,
    <img src={trello} alt="Trello" className="h-10 w-10" />,
  ];
  const appsRow3 = [
    <img src={airtable} alt="Airtable" className="h-10 w-10" />,
    <img src={dropbox} alt="Dropbox" className="h-10 w-10" />,
    <img src={discord} alt="Discord" className="h-10 w-10" />,
    <img src={drive} alt="Drive" className="h-10 w-10" />,
    <img src={zoom} alt="Zoom" className="h-10 w-10" />,
  ];
